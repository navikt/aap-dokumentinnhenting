...
data class BehandlingsflytToDialogmeldingDTO(
    ...
    val dialogmeldingType: String,           // Type dialogmelding: DIALOG_FORESPORSEL, DIALOG_SVAR og DIALOG_NOTAT. Når det sendes en DIALOG_FORESPORSEL, kreves det et DIALOG_SVAR tilbake. DIALOG_NOTAT er en melding som ikke krever svar, feks noe som kun er til informasjon.
