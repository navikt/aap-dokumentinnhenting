...
object SafGateway {
    ...
    suspend fun hentDokumenterForJournalpost(journalpostId: JournalpostId, token: OidcToken): List<BegrensetDokumentInfoDto> {
        val request = SafRequest(
        ...
        return response.data?.dokumentoversiktJournalpost?.dokumenter.orEmpty()
    }
